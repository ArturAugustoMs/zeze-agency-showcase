...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sites institucionais modernos, rápidos e responsivos para restaurantes, cafeterias, barbearias e pequenos negócios." },
      { name: "author", content: "Zeze" },
      { name: "theme-color", content: "#ffffff" },
      { property: "og:title", content: "Zeze — Sites profissionais para o seu negócio" },
      { property: "og:description", content: "Sites institucionais modernos, rápidos e responsivos para restaurantes, cafeterias, barbearias e pequenos negócios." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Zeze" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Zeze",
          description: "Desenvolvimento de sites profissionais para pequenos negócios.",
          url: "/",
        }),
      },
    ],
